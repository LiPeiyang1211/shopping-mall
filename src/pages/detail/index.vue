        ...
        <li v-for="(list, index) in goodDetails" :key="index">
              ...
              <div class="layer" v-show="show" @click="show = !show">
                ...
                <div class="layer-box-2">
                  ...
                  <div class="layer-box-2-1 top">
                    ...
                    <p>
                      换新鼓励金通过参加以回购以后获得，享受额外补贴。
                      <router-link to="/change">老用户回购</router-link>
                    </p>
                  </div>
                </div>
          ...
          <div class="goodDetailBox">
            <mt-navbar v-model="selected">
              ...
              <mt-tab-item id="tab-container2">包装清单</mt-tab-item>
            </mt-navbar>
          ...
          <van-goods-action>
            ...
            <van-goods-action-icon icon="cart-o" text="购物车" :badge="$store.state.cart.carts.length"@click="jumpCart()"/>
